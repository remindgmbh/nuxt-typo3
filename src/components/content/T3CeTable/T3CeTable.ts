...
export default BaseCe.extend({
    ...
    render(createElement: CreateElement): VNode {
        ...
        return createElement('div', { class: 't3-ce-table' }, [
            createElement('ce-header', { props: this.$props }),
            createElement('div', { class: 't3-ce-table__container' }, [
                createElement('div', {
                    class: [
                        't3-ce-table__overlay-left',
                        { 't3-ce-table__overlay-left--visible': !this.left },
                    ],
                }),
                createElement('div', {
                    class: [
                        't3-ce-table__overlay-right',
                        { 't3-ce-table__overlay-right--visible': !this.right },
                    ],
                }),
                createElement(
                    'div',
                    { class: 't3-ce-table__viewport', ref: 'viewport' },
                    [
